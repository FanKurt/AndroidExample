...
public class BlockView extends ImageView {
	 ...
	 *            容器的高
	 */
	public BlockView(Context context, int w, int h) {
		super(context);
...
//		Rebound(disX, disY);
	...
	private void setPosition(int left, int top, int right, int bottom) {
			RelativeLayout.LayoutParams LP = new RelativeLayout.LayoutParams(right-left , bottom-top);
			LP.leftMargin =  left;
			LP.topMargin = top;
	...
	public float getX(){
		return stop_x - start_x;
	}
	public float getY(){
		return stop_y - start_y;
	}
}