...
public class HealthDialogView extends MainParentLayout implements
		OnClickListener {
	...
	private void LogTitle() {
		{
			...
			severityTextViewy.setText("SEVERITY");
		...
		
		{
			...
			detailTextView.setText("DEATAILS");
	...
	private void titleBar() {
		{
			...
			iconView.setBackgroundResource(R.drawable.health_128);
		...
		}
		{
			...
			text_title.setText("Health Report");
	...
	public HealthDialogView setOnReportListener(OnReportListener ORNA) {
		this.mOnReportListener = ORNA;
		return this;
	}


	public HealthDialogView Show() {
